...
# "Samsung Galaxy S8-7.0", include after fixing https://gitlab.com/censorship-no/ceno-browser/-/issues/172
DEVICES='["Samsung Galaxy S9-8.0", "Huawei P30-9.0", "Xiaomi Redmi Note 8-9.0", "Samsung Galaxy A51-10.0", "Xiaomi Redmi Note 11-11.0", "Google Pixel 6-12.0", "Samsung Galaxy S23-13.0", "Samsung Galaxy S24-14.0"]'
